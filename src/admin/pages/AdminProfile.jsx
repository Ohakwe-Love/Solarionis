    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-6">
                <div className="w-14 h-14 rounded-full bg-(--solar-gold)/15 text-(--solar-gold) flex items-center justify-center mb-4">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-6">
                <div className="flex items-center gap-2 mb-4">
                    <ShieldCheck className="w-5 h-5 text-(--solar-gold)" />
                ...
                <div className="rounded-xl border border-zinc-800 bg-black/30 p-4">
                    ...
                    <p className="text-zinc-100 font-semibold flex items-center gap-2">
                        <Activity className="w-4 h-4 text-(--solar-gold)" />
                        {status}
                    </p>
                </div>
            </div>
